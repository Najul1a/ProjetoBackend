...
namespace ProjetoBackend.Controllers
{
    public class ComprasController : Controller
    {
        ...
        {
            ViewData["FornecedoresId"] = new SelectList(_context.Fornecedores, "FornecedorId", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CompraId,FornecedorId,DataCompra,ValorTotal")] Compra compra)
        {
            ...
            ViewData["FornecedoresId"] = new SelectList(_context.Fornecedores, "FornecedorId", "Nome", compra.FornecedorId);
            return View(compra);
        }
